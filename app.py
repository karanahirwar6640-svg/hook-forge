...
<head>
    ...
    <style>
        ...
        .crimson-btn:hover { 
            background: linear-gradient(45deg, #991b1b, #f87171); 
        ...
        .audio-btn { 
            ...
            border: 1px solid rgba(255,50,50,0.4); 
            color: #ef4444; transition: all 0.3s; 
        }
        ...
        .tab-active { 
            ...
            border: 1px solid #ef4444; color: #fef3c7; 
...
<body class="p-4">
    ...
    <button onclick="toggleAudio()" class="audio-btn shadow-lg hover:scale-110">
